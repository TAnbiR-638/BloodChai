...
// $qry="SELECT CITY_NAME FROM state WHERE CITY_ID={$_POST["CITY"]}";
// $res=$con->query($qry);
// if($res->num_rows>0)
// {
// 	if($row=$res->fetch_assoc())
...
(NAME, FATHER_NAME, GENDER, DOB, BLOOD, BODY_WEIGHT, EMAIL, ADDRESS , COUNTRY, CITY, AREA, CONTACT_1, CONTACT_2,NEW_DONOR, LAST_D_DATE, DONOR_PIC)
 VALUES 
 ('{$_POST["NAME"]}', '{$_POST["FATHER_NAME"]}', '{$_POST["GENDER"]}', '{$_POST["DOB"]}', '{$_POST["BLOOD"]}', '{$_POST["BODY_WEIGHT"]}', '{$_POST["EMAIL"]}', '{$_POST["ADDRESS"]}', '{$_POST["COUNTRY"]}','{$_POST["CITY"]}', '{$_POST["AREA"]}', '{$_POST["CONTACT_1"]}', '{$_POST["CONTACT_2"]}', '{$_POST["NEW_DONOR"]}','{$_POST["LAST_D_DATE"]}', '{$img}');";
						if($con->query($sql))
							{
								echo '
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
						...
						<div class="form-group">
							<label class="control-label text-primary" for="COUNTRY" >Blood Group</label>
							<select id="COUNTRY" name="COUNTRY" required class="form-control input-sm">	
								...
								<div class="form-group">
									<label class="control-label text-primary" for="COUNTRY">Division</label>
									<select name="CITY" id="CITY" required class="form-control">
										<option value="">Select City</option>
										<?php
											$sql = "SELECT DISTINCT CITY_NAME FROM area2 ORDER BY CITY_NAME ASC";
											...
											if ($result->num_rows > 0) {
												while ($row = $result->fetch_assoc()) {
													...
													// $u = $_POST["DIVISON"]; // Change DIVISON to COUNTRY
								...
								<div class="form-group">
									...
									<select name="AREA" id="AREA" required class="form-control">
										...
										<?php
												...
												$sql = "SELECT DISTINCT AREA_NAME FROM area2 WHERE CITY_NAME='DHAKA' ORDER BY AREA_NAME ASC";
												$result = $con->query($sql);
						  ...
						  <!-- <div class="form-group">
								...
								<label class="control-label text-primary" for="CITY" >Area</label>
                                <select name="CITY" id="CITY" required class="form-control">
								<option value="">Select Area</option>
								<?php 
